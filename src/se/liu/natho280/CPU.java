...
public class CPU {
     ...
     * @see Main
     */
    public CPU(String romPath, Memory memory, Registers regs) {
        this.memory = memory;
        this.regs = regs;
    }
...
//        String stateString = "";
//
//        stateString += "Instruction: 0x" + hex.toHexDigits((byte)memory.read(regs.get(Reg.PC))) + " ";
//
//        stateString += "A:" + hex.toHexDigits((byte)regs.get(Reg.A)).toUpperCase() + " ";
//        stateString += "F:" + hex.toHexDigits((byte)regs.get(Reg.F)).toUpperCase() + " ";
//        stateString += "B:" + hex.toHexDigits((byte)regs.get(Reg.B)).toUpperCase() + " ";
//        stateString += "C:" + hex.toHexDigits((byte)regs.get(Reg.C)).toUpperCase() + " ";
//        stateString += "D:" + hex.toHexDigits((byte)regs.get(Reg.D)).toUpperCase() + " ";
//        stateString += "E:" + hex.toHexDigits((byte)regs.get(Reg.E)).toUpperCase() + " ";
//        stateString += "H:" + hex.toHexDigits((byte)regs.get(Reg.H)).toUpperCase() + " ";
//        stateString += "L:" + hex.toHexDigits((byte)regs.get(Reg.L)).toUpperCase() + " ";
//        stateString += "SP:" + hex.toHexDigits((short)regs.get(Reg.SP)).toUpperCase() + " ";
//        stateString += "PC:" + hex.toHexDigits((short)regs.get(Reg.PC)).toUpperCase() + " ";
//        stateString += "PCMEM:" + hex.toHexDigits((byte)memory.read(regs.get(Reg.PC))).toUpperCase() + ","+
//                hex.toHexDigits((byte)memory.read(regs.get(Reg.PC) + 1)).toUpperCase() + ","+
//                hex.toHexDigits((byte)memory.read(regs.get(Reg.PC) + 2)).toUpperCase() + "," +
//                hex.toHexDigits((byte)memory.read(regs.get(Reg.PC) + 3)).toUpperCase() + "\n";
//
//        try {
...
//        }
        ...
        // if (regs.get(Reg.PC) == 0x48) System.out.println("WOOOOOOOOOOOOOOOOOOOOO");
        ...
        switch (firstNibble) {
            ...
            case 0x6:
                ...
                break;
            case 0x7:
//                if (regs.get(Reg.PC) == (0xc08d + 1)) System.out.println("B IS: " + regs.get(Reg.B));
            ...
            case 0xF:
                switch (secondNibble) {
                    ...
                    case 0x8:
                        ...
                        regs.setHalfcarryFlag(((regs.get(Reg.SP) & 0xF) + (s8 & 0xF)) > 0xF);
                        regs.setCarryFlag((regs.get(Reg.SP) & 0xFF) + (s8 & 0xFF) > 0xFF);
                        //regs.set(Reg.SP, regs.get(Reg.SP) + s8); // should this be here????

                        regs.set(Reg.HL, regs.get(Reg.SP) + s8);
                        // regs.set(Reg.HL, regs.get(Reg.SP) + s8); // or this???
                        cycles += 2;
                        break;
                    case 0x9:
                        // LD SP, HL
