...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        THERE IS NO CHANCE WE ARE ACTUALLY DONE WITH THE PPU YET, we just got simple backgrounds to work.
        ...
        The Memory/SharedMemory classes are in desperate need of cleanup, they are held together by duct tape & a prayer

        Implement MBCs (mapper, switching between memory banks on the ROM)
